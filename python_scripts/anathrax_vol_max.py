...
def process_post_contractual(files: List[str]) -> pd.DataFrame:
    ...
    result_df.loc[4, 0] = ""  # Empty security description
...
def main():
    ...
    input_folder = "excel_books/aladdin_data/Input"
    output_folder = "excel_books/aladdin_data/Output"
    ...
    try:
        ...
        logging.info(
            "Processing complete. Results have been saved to new Excel files for each group of portfolios."
        )
    except Exception as e:
